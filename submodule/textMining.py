...
class LDA_gensim :
    ...
    def save(self, directory, file_name, data) :
        ...
        self.get_TVByTime(data, 'year_application').to_excel(writer , sheet_name = 'TVByTimes', index = 1)
        self.get_summary_TVByTime(10).to_excel(writer , sheet_name = 'TVByTimes_summary', index = 1)
